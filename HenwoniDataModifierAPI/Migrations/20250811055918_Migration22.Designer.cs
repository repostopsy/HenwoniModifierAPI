...
namespace HenwoniDataModifierAPI.Migrations
{
    ...
    [Migration("20250811055918_Migration22")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Common.RefCJTDescriptionTemplateAlias", b =>
                {
                    ...
                    b.ToTable("RefCJTDescriptionTemplateAlias");
                });
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Common.RefCJTDescriptionTemplateTag", b =>
                {
                    ...
                    b.ToTable("RefCJTDescriptionTemplateTag");
                });
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Location.Transilation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplate", b =>
                {
                    ...
                    b.ToTable("RefCServiceTitleTemplates");
                });

            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplateAlias", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("RefCServiceTitleTemplateId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RefCServiceTitleTemplateId");

                    b.ToTable("RefCServiceTitleTemplateAliases");
                });

            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplateTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RefCServiceTitleTemplateTags");
                });
            ...
            modelBuilder.Entity("RefCJTDescriptionTemplateRefCJTDescriptionTemplateTag", b =>
                {
                    ...
                    b.ToTable("RefCJTDescriptionTemplateRefCJTDescriptionTemplateTag");
                });

            modelBuilder.Entity("RefCServiceTitleTemplateRefCServiceTitleTemplateTag", b =>
                {
                    b.Property<long>("RefCServiceTitleTemplatesId")
                        .HasColumnType("bigint");

                    b.Property<long>("TagsId")
                        .HasColumnType("bigint");

                    b.HasKey("RefCServiceTitleTemplatesId", "TagsId");

                    b.HasIndex("TagsId");

                    b.ToTable("RefCServiceTitleTemplateRefCServiceTitleTemplateTag");
                });
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Common.RefCJTDescriptionTemplate", b =>
                {
                    ...
                    b.HasOne("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitle", null)
                        .WithMany("Descriptions")
                        .HasForeignKey("RefCServiceTitleId");
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Common.RefCJTDescriptionTemplateAlias", b =>
                {
                    ...
                    b.HasOne("HenwoniDataModifierAPI.Models.Common.RefCJTDescriptionTemplate", null)
                        .WithMany("Aliases")
                        .HasForeignKey("RefCJTDescriptionTemplateId");
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Employment.JobContractType", b =>
                {
                    ...
                    b.HasOne("HenwoniDataModifierAPI.Models.Employment.JobContractType", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplate", b =>
                {
                    ...
                    b.HasOne("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitle", "RefCServiceTitle")
                        .WithMany("RefCServiceTitleTemplates")
                        .HasForeignKey("RefCServiceTitleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplateAlias", b =>
                {
                    ...
                    b.HasOne("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplate", null)
                        .WithMany("Aliases")
                        .HasForeignKey("RefCServiceTitleTemplateId");
            ...
            modelBuilder.Entity("RefCJTDescriptionTemplateRefCJTDescriptionTemplateTag", b =>
                {
                    b.HasOne("HenwoniDataModifierAPI.Models.Common.RefCJTDescriptionTemplateTag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RefCServiceTitleTemplateRefCServiceTitleTemplateTag", b =>
                {
                    b.HasOne("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplate", null)
                        .WithMany()
                        .HasForeignKey("RefCServiceTitleTemplatesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitleTemplateTag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HenwoniDataModifierAPI.Models.Services.Common.RefCServiceTitle", b =>
                {
                    ...
                    b.Navigation("CandidateSoftSkills");

                    b.Navigation("Descriptions");

                    b.Navigation("JobIndustries");

                    b.Navigation("RefCServiceTitleTemplates");
                });
